...
class FakeSharedPreferences : SharedPreferences, Editor {
    ...
    override fun putBoolean(key: String, value: Boolean): Editor = apply { tempValues[key] = value }

    override fun putFloat(key: String, value: Float): Editor = apply { tempValues[key] = value }

    override fun putInt(key: String, value: Int): Editor = apply { tempValues[key] = value }

    override fun putLong(key: String, value: Long): Editor = apply { tempValues[key] = value }

    override fun putString(key: String, value: String?): Editor =
        apply { if (value != null) tempValues[key] = value }

    override fun putStringSet(key: String, values: Set<String>?): Editor =
        apply { if (values != null) tempValues[key] = values }
